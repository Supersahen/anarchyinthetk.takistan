...
for [{_i=0}, {_i < (count huntingarray)},{_i=_i+1}] do {
		...
		[_array] spawn {
				...
				private ["_i", "_array", "_marker", "_text", "_area", "_classes", "_limits", "_timers", "_pos", "_area1", "_area2", "_sleepy", "_spawnTime", "_class", "_limit", "_timer", "_animals1", "_animals2", "_spawnTime_0", "_spawnTime_1", "_spawnTime_2", "_spawnTime_3", "_spawnTime_4", "_spawnTime_5", "_spawnTime_6", "_spawnTime_7", "_spawnTime_8", "_spawnTime_9", "_spawnTime_10", "_animal"];
